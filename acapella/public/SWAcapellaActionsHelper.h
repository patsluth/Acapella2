...
static NSDictionary *_lastNowPlayingInfo;

@protocol SWAcapellaActionProtocol <NSObject>

@required

@property (strong, nonatomic) NSDictionary *lastNowPlayingInfo;
...
//each individual instance will handle this itself
//+ (void)action_ShowPlaylistOptions:(SWAcapellaActionsCompletionBlock)completion;
